...
//------------------------------------------------------------------------------------------------------------------
static bool CheckAndReturnVectorComponent(int lineNo, VectorProcessItem* pVector, int iVectorIndex, char* structItem, const ArrayOfBaseProcessInputs*& outVectorComponent, std::pair<int,int>& outIndex)
{
