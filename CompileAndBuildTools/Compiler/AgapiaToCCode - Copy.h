...
void SetInputItemToVector(int lineNo, VectorProcessItem* pVector, int iVectorIndex, char* structItem, int value);
void SetInputItemToVector(int lineNo, VectorProcessItem* pVector, int iVectorIndex, char* structItem, float value);
void SetInputItemToVector(int lineNo, VectorProcessItem* pVector, int iVectorIndex, char* structItem, char* value);
void SetInputItemToVector(int lineNo, VectorProcessItem* pVector, int iVectorIndex, char* structItem, char* value, int buffSize);
